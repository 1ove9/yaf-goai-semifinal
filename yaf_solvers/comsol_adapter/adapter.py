"""COMSOL Multiphysics solver adapter (skeleton). Requires COMSOL license + MPh."""
...
class COMSOLAdapter(BaseSolverAdapter):
    """COMSOL Multiphysics solver adapter (skeleton). Requires COMSOL license + MPh."""
    ...
    async def capabilities(self) -> dict[str, Any]:
        ...
        caps.update({"multiphysics": True, "requires_license": True})
        return caps
