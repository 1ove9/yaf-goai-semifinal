...
class GeometryError(YAFError):
    """Geometry validation/conversion failure."""


class OptimizationError(YAFError):
    """Optimization run failure."""


class StorageError(YAFError):
    """Object storage I/O failure."""


class ValidationError(YAFError):
    """Domain model validation failure."""
